 ...
 */
class grapefruitbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "grapefruit@grapefruit";
    public $boxlabel;
    public $depends = array("grapefruit");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/grapefruit/class/grapefruit.class.php";
